			...
			<table width="580"  class="deviceWidth" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#eeeeed" style="margin:0 auto;">
                <tr>
                    <td class="column" width="640" valign="top">
                                    <table border="0" cellpadding="0" cellspacing="0" summary="" width="640">
                                        <tr><td class="sectionMainTitle">Your New Login Password: </td></tr>
                                        <tr><td>&nbsp;</td></tr>
                                        <tr>
                                            <td class="sectionMainContent">
                                ...
                                <tr>
                                    <td align="center" style="font-size: 12px; color: #959595; font-weight: normal; text-align: left; font-family: Georgia, Times, serif; line-height: 24px; vertical-align: top; padding:10px 8px 10px 8px">
                                        ...
                                        <p style="mso-table-lspace:0;mso-table-rspace:0; margin:0">
                                         ...
                                         <a href="http://www.ushodhayamatrimonial.com"
                                                        style="
                                                        color:#ffffff;
                                                        font-size:13px;
                                                        font-weight:bold;
